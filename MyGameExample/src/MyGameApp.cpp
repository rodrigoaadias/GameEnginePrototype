...
void MyGameApp::addDescriptorSets()
{
...
bool MyGameApp::addSwapChain()
	...
	void MyGameApp::addRootSignatures()
	{
	...
	void MyGameApp::removeRootSignatures()
	{
		removeRootSignature(pRenderer, pRootSignature);
	}

	void MyGameApp::addShaders()
	{
	...
	void MyGameApp::removePipelines()
	{
